...
import com.d1m.social.wechat.pandora.integration.layer.api.constant.Config;
	...
	public void onStartup() {
		...
		try {
			...
			for (Entry<Object, Object> m : properties.entrySet()) {
				...
				if(((String) m.getKey()).indexOf("org.quartz") > -1) {
					properties().setProperty((String)m.getKey(), (String)m.getValue());
				}
			}
		} catch (IOException e) {
